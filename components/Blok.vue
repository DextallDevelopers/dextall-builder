  ...
  switch (name) {
    case 'images_list':
      return defineAsyncComponent(
        () => import(`~/components/ImagesList.vue`)
    )
    ...
    case 'benefits1':
      return defineAsyncComponent(
        () => import('~/components/Benefits1.vue')
    )
     
    case 'benefits2':
      return defineAsyncComponent(
        () => import('~/components/Benefits2.vue')
    )
    ...
    case 'drawings':
      return defineAsyncComponent(
        () => import('~/components/Drawings.vue')
    )
    ...
    case 'included':
      return defineAsyncComponent(
        () => import('~/components/Included.vue')
    )
